$(document).ready(function() {  
  $(".btn-default").on("click", function(e){
    e.preventDefault();   // prevents the default button event
  ...
  function flickrSuccessHandler(response) { //function running because the AJAX request was successful
    var locationPhotos = response.photos.photo; // assigning the results from AJAX request into locationPhones
