$(document).ready(function(){
  ...
  function guardianAPI(){
    ...
    var Appid = "xqH9UulnxWvYID2if8wODlrsrvBKXFrlnKE8TmGDdJI";
    var Appid = base64_encode(":" + Appid);
    ...
    var requestStr = "https://api.datamarket.azure.com/Data.ashx/Bing/Search/v1/News?Query=%27Seattle%27&$top=50&$format=json";
    $.ajax({
      url: requestStr,
